...
public class ExcelUtil  { 
	private static Integer  sheetSize=65535;
	//private static  String sheetName="Sheet";
	public static <T> String Excel(List<T> list,LinkedHashMap<String, String> fieldMap,String sheetName,HttpServletResponse response) throws Exception {
	String fileNames=	ExcelUtil.listToExcel2(list, fieldMap, sheetName, sheetSize, response);
	return fileNames;	
	}
	...
	public static <T> void listToExcel1(
	...
	public static <T> String listToExcel2(
	...
	public static <T> void listToExcel3(
