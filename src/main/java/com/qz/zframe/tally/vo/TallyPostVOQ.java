...
import com.qz.zframe.tally.entity.RouteUser;
import io.swagger.annotations.ApiModelProperty;

import java.util.Date;
import java.util.List;

public class TallyPostVOQ {
    //流水号
    ...
    @ApiModelProperty(value="windName",name="风电场名称",required=true)
    ...
    @ApiModelProperty(value="周期单位转换文本",name="cycleUnitText",required=true)
    ...
    private List<RouteUserVO> routeUsers;

    public List<RouteUserVO> getRouteUsers() {
        return routeUsers;
    }

    public void setRouteUsers(List<RouteUserVO> routeUsers) {
