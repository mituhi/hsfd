...
public class WorkTicketForWorkorederVo {

    @ApiModelProperty(name = "ticketId", value = "工作票id", required = false)
    private String ticketId;

    @ApiModelProperty(name = "serialNumber", value = "工作票号", required = false)
    ...
    @ApiModelProperty(name = "workContent", value = "工作内容", required = false)
